...
const AuthLayout = ({ children }) => {
    return (
        <div className="flex min-h-screen bg-cover bg-center relative" style={{ backgroundImage: `url(${Background})` }}>
            ...
            <div className=' relative w-full md:w-1/2 flex justify-center items-center p-10'>
                {children}
            </div>
        </div>
    )
